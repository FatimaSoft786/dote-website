            ...
            <div className=" border rounded-lg">
              <div className=" grid grid-cols-3 gap-28">
                <div className=" flex flex-col justify-start ml-28 mt-10">
                  ...
                  {t('Add your own curriculum or upgrade to get Experience Curriculum, including digital lesson plans and hands-on learning materials')}
                  </p>
                </div>
                ...
                <div className=" flex flex-col justify-start ml-28 mt-10">
                  <img className=" w-16 h-16" src={charge} alt="" />
                  <hi className=" font-semibold text-black text-base mt-8">
                  {t('State learning & DRDP standards')}
                  </hi>
                  <p className=" font-regular text-[#141E3E] mt-3 w-60 h-auto">
                ...
                <div className=" flex flex-col justify-start ml-28 mt-10">
                  ...
                  <p className=" font-regular text-[#141E3E] mt-3 w-60 h-auto">
                  {t('Share learning and development with staff and parents on your own schedule')}
                  </p>
                </div>
              </div>
